...
%% Paquetes usados para este trabajo
\usepackage{physics}
...
%%Personalizaciones usados para este trabajo
...
\begin{document}
	...
	\keywords{quantum computing, quantum circuits, quantum logic, quantum simulation}
	\maketitle
 ...
 In this section, some specific properties involving  the controlled Pauli-\gate{X} gate are demonstrated.
    ...
    \begin{enumerate} % TODO: Añadir explicaciones de los diferentes circuitos y referencias a los mismos.
